...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, S(KC_PLUS), KC_BSPC, RGB_HUI, RGB_VAI, RGB_SPI,
    ...
    [2] = LAYOUT(
        ...
        KC_TRNS, RALT(KC_MINS), S(KC_7), RALT(KC_7), RALT(KC_0), S(KC_RBRC), S(KC_MINS), S(KC_8), S(KC_9), S(KC_SLSH), S(KC_DOT), RALT(KC_Q), KC_TRNS,
        KC_TRNS, KC_QUOT, S(KC_4), RALT(KC_NUBS), RALT(KC_RBRC), S(KC_QUOT), KC_RBRC, S(KC_5), S(KC_2), S(KC_QUOT), S(KC_COMM), KC_TRNS, KC_TRNS,
